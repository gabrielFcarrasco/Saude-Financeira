...
export const TrilhaEducacional: React.FC<TrilhaProps> = ({ perfil }) => {
  ...
  return (
    <div className="trilha-educacional-page">
      
      {/* PAGE HEADER ABOVE THE CARD (FORA DO CARD) */}
      <div className="trilha-educacional-header">
        <span className="diagnostico-finalizado-badge">Diagnóstico Finalizado</span>
        
        {/* Main large title from the image */}
        <h1 className="trilha-main-title">
          <span>Trilha</span> <span className="de">de</span> <span className="text-accent">Aprendizado</span>
        </h1>
      </div>
      
      {/* The div.card from before */}
      <div className="card" style={{ maxWidth: '900px', width: '100%', margin: '0 auto', position: 'relative' }}>
        {/* Step progress dynamic bar */}
        ...
        <div style={{ minHeight: '450px' }}>
          {/* Step title h2, e.g., '1. Diagnóstico Profundo' from the image */}
          ...
          {/* ================= O E-BOOK FINAL - step type ebook only ================= */}
            ...
            <div className="step-content animate-fade-in">
              ...
              <div className="ebook-container">
                ...
                <div style={{ flex: 1, textAlign: 'left' }}>
                  ...
                  <p style={{ fontSize: '1.1rem', lineHeight: '1.6', marginBottom: '24px', color: 'var(--text)' }}>Descubra exatamente onde você está e o que precisa fazer para avançar: <br/><br/><strong>1. Endividamento</strong><br/><strong>2. Equilíbrio</strong><br/><strong>3. Acumulação</strong><br/><strong>4. Liberdade Financeira</strong></p>
                  
                  {/* Botão Premium de Download */}
                  <a href="/Ebook/Finanças Pessoais - As 4 Fases da Vida Financeira (Gabriel Carrasco).pdf" download="Guia_As_4Fases_Financeiras_Gabriel_Carrasco.pdf" className="btn-download">
      ...
      {/* ================= NAVEGAÇÃO (BOTÕES SEPARADOS DO CARD) ================= */}
      <div className="trilha-nav">
        <button className="btn-nav-secundary" onClick={voltar} disabled={passoAtual === 1}>
        ...
        {passoAtual < totalPassos ? (
          ...
          <button className="primary btn-nav-primary btn-final" onClick={() => window.location.href = '/'}>Finalizar Jornada</button>
        )}
      </div>
